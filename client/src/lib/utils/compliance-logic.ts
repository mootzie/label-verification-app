...
export const BATCH_STATUS_VARIANT: Record<string, 'not_found' | 'warning' | 'pass' | 'fail'> = {
    pending: 'not_found',
    processing: 'warning',
    complete: 'pass',
    failed: 'fail'
...
export function borderCls(fieldResultMap: Map<string, FieldResult>, fieldName: string): string {
