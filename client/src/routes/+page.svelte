...
>
    ...
    {:else}
        <!-- Intake phase: application data and upload stay visible until verification starts. -->
        <div
                        ...
                        >
                            ...
                            {:else}
                                ...
                                >
                                    ...
                                    >
                                        Drag and drop label images anywhere on
                                        the screen
                                    </p>
            ...
            >
                <div class="flex flex-col items-center gap-3 p-8 text-center">
                    ...
                    <p class="max-w-xs text-sm text-gray-400">
                        Drag and drop an image anywhere on the screen and click
                        "Verify Label" to see results here.
                    </p>
                    {#if labelUploaded}
                        <Button
                            disabled={files.length === 0 ||
                                ...
                                submitting}
                            onclick={handleSubmit}
                            class="h-11 bg-blue-900 px-5 font-semibold text-white hover:bg-blue-800 disabled:opacity-50"
                        >
                            Verify Label
                        </Button>
                    {/if}
